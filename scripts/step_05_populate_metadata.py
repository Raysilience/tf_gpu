...
# coding utf-8
'''
@File       :step_05_populate_metadata.py
@Copyright  :CV Group
@Date       :10/11/2021
@Author     :Rui
@Desc       :
...
def define_flags():
    flags.DEFINE_string("model_file", "{0}{1}_{2}.tflite".format(SAVED_MODEL_DIR, MODEL_NAME, VERSION),
                        "Path and file name to the TFLite model file.")
    flags.DEFINE_string("label_file", LABEL_FILE, "Path to the label file.")
