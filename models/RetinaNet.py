...
class MobileNetV2(tf.keras.Model):
    ...
    def call(self, inputs, training=None, mask=None):
        ...
        p1 = self.bottleneck1(x, training=training)
        p2 = self.bottleneck2(p1, training=training)
        p3 = self.bottleneck3(p2, training=training)
        p4 = self.bottleneck4(p3, training=training)
        x = self.bottleneck5(p4, training=training)
        x = self.bottleneck6(x, training=training)
        p5 = self.bottleneck7(x, training=training)
        return p3, p4, p5
